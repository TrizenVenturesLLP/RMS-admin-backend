...
/**
 * Complete HT Exhaust Categories
 * This script adds ALL missing categories from the HT Exhaust website
 * Target: 200+ categories to match the reference website
 */
...
const addCompleteHTExhaustCategories = async () => {
  try {
    console.log('🏍️ Adding complete HT Exhaust category structure...');
    ...
    // YAMAHA - Complete with all models
    ...
    // ROYAL ENFIELD - Complete with all models
    ...
    // BAJAJ - Complete with all models
    ...
    // HONDA - Complete with all models
    ...
    // SUZUKI - Complete with all models
    ...
    // KAWASAKI - Complete with all models
    ...
    // BENELLI - Complete with all models
    ...
    // JAWA - YEZDI - Complete with all models
    ...
    // TRIUMPH - Complete with all models
    ...
    // HARLEY DAVIDSON - Complete with all models
    ...
    // DUCATI - Complete with all models
    ...
    // MAHINDRA - Complete with all models
    ...
    console.log('\n🎉 Complete HT Exhaust categories added successfully!');
    ...
    console.error('❌ Error adding complete categories:', error);
    process.exit(1);
  }
};

addCompleteHTExhaustCategories();
