...
const fixBothEnvironments = async () => {
  try {
    ...
    const scooterModels = [
      'ACTIVA 6G', 'ACTIVA 125', 'DIO 125', 'ACCESS 125', 'BURGMAN STREET',
