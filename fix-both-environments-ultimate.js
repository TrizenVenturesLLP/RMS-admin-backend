...
const fixBothEnvironments = async () => {
  try {
    ...
    const suzukiModels = [
      ...
      'GIXXER NAKED 150cc BS6', 'GIXXER NAKED 250', 'BURGMAN', 'AVENIS 125'
    ];
    ...
    // Create scooter models - COMPLETELY UNIQUE SCOOTER MODELS ONLY
    console.log('🛵 Creating scooter models...');
    const scooterModels = [
      'ACTIVA 6G', 'ACTIVA 125', 'DIO 125', 'BURGMAN STREET',
      'AVENIS 125', 'JUPITER 125', 'JUPITER 110', 'NTORQ 125', 'RAY ZR 125'
    ];
